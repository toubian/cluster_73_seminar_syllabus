...
| 2    | Apr 9      | Cognitive Processes and Computational Models | Excerpt from *Critical Code Studies* by Mark C. Marino<br>A World Appears (Intro + Chapter 1)                                                       | Writing workshop: Evaluating sources                                                                          |
| 3    | Apr 16     | Neural Pathways and Info Processing       | Excerpt from *The Brain That Changes Itself* by Norman Doidge<br>Modes of Cognition                                            | Project 1 introduced<br>Final project prompt<br>Writing workshop: Annotating sources                          |
| 4    | Apr 23     | Memory Systems: Biological and Artificial | Big Capta? by Jeremy Hunsinger<br>The Empty Brain                                                       | Final project brainstorming<br>Writing workshop: Thesis statement<br>Project 1 due<br>Project meeting        |
